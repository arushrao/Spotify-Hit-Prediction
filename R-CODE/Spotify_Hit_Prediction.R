...
paste("Validation Data Accuracy:",round(knn_accuracy_validation*100,digits=2),"%")
...
paste("Training Data Accuracy:",round(dt_accuracy_training*100,digits=2),"%") # ~78% accuracy with 0.7 split
